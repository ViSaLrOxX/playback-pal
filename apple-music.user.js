// ==UserScript==
// @name         playback-pal · Apple Music
// @namespace    https://github.com/ViSaLrOxX/playback-pal
// @version      1.0.0
// @description  Playback speed controls for Apple Music
// @author       ViSaLrOxX
...
(function () {
  ...
  GM_addStyle(`
    ...
    .ppb.active {
      ...
      border-color: rgba(252,60,68,0.38);
      color: #fc3c44;
    }
    #pp-custom {
      display: flex;
    ...
    #pp-custom-input:focus { border-color: rgba(252,60,68,0.4); }
    ...
    #pp-custom-btn:hover { background: rgba(252,60,68,0.22); }
    #pp-sub {
      font-size: 9px;
