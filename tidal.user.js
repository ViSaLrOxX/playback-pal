// ==UserScript==
// @name         playback-pal · Tidal
// @namespace    https://github.com/ViSaLrOxX/playback-pal
// @version      1.0.0
// @description  Playback speed controls for Tidal
// @author       ViSaLrOxX
...
(function () {
  ...
  GM_addStyle(`
    ...
    #pp-custom-input:focus { border-color: rgba(255,255,255,0.4); }
    ...
    #pp-custom-btn:hover { background: rgba(255,255,255,0.2); }
    #pp-sub {
      font-size: 9px;
