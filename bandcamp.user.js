// ==UserScript==
// @name         playback-pal · Bandcamp
// @namespace    https://github.com/ViSaLrOxX/playback-pal
// @version      1.0.0
// @description  Playback speed controls for Bandcamp
// @author       ViSaLrOxX
// @match        *://*.bandcamp.com/*
// @grant        GM_addStyle
// @grant        unsafeWindow
...
(function () {
  ...
  GM_addStyle(`
    ...
    #pp-cur {
      ...
      border: 1px solid rgba(29,160,195,0.25);
      border-radius: 5px;
      padding: 1px 8px 2px;
    }
    #pp-hide {
    ...
    .ppb.active {
      background: rgba(29,160,195,0.14);
      border-color: rgba(29,160,195,0.38);
      color: #1da0c3;
    }
    #pp-custom {
      display: flex;
    ...
    #pp-custom-input:focus { border-color: rgba(29,160,195,0.4); }
    ...
    #pp-custom-btn:hover { background: rgba(29,160,195,0.22); }
    #pp-sub {
      font-size: 9px;
    ...
    #pp-pill {
      ...
      z-index: 2147483646;
      background: rgba(0,0,0,0.88);
      border: 1px solid rgba(29,160,195,0.28);
      border-radius: 20px;
